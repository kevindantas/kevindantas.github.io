    ...
    return (
      <Wrapper>
        ...
        <Infos>
          ...
          <SocialLink href="https://www.behance.net/kevindantas" target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="25">
              <path fill="#fff" d="M31.6 3.1h-8.8V.9h8.8v2.2zM17 12c.6.9.8 1.9.8 3.2 0 1.3-.3 2.5-1 3.5-.4.7-.9 1.2-1.5 1.7-.7.5-1.5.9-2.5 1.1-.9.2-2 .3-3.1.3H0V0h10.5c2.7 0 4.5.8 5.6 2.3.7.9 1 2 1 3.3 0 1.3-.3 2.4-1 3.2-.4.5-.9.9-1.7 1.2 1.2.5 2 1.1 2.6 2zM5 8.6h4.6c.9 0 1.7-.2 2.3-.5.6-.4.9-1 .9-1.9 0-1-.4-1.7-1.2-2-.6-.3-1.5-.4-2.5-.4H5v4.8zm8.3 6.3c0-1.1-.5-1.9-1.4-2.3-.5-.2-1.2-.4-2.2-.4H5V18h4.6c.9 0 1.7-.1 2.2-.4 1-.5 1.5-1.4 1.5-2.7zm21.6-3.5c.1.7.2 1.7.1 3.1H23.6c.1 1.6.6 2.7 1.6 3.3.6.4 1.4.6 2.2.6.9 0 1.7-.2 2.3-.7.3-.3.6-.6.8-1.1h4.2c-.1.9-.6 1.9-1.5 2.8-1.4 1.5-3.4 2.3-5.9 2.3-2.1 0-3.9-.6-5.5-1.9-1.6-1.3-2.4-3.4-2.4-6.2 0-2.7.7-4.8 2.1-6.2 1.4-1.4 3.3-2.2 5.6-2.2 1.4 0 2.6.2 3.7.7 1.1.5 2 1.3 2.7 2.3.8.9 1.2 1.9 1.4 3.2zm-4.1.4c-.1-1.1-.4-1.9-1.1-2.5-.6-.6-1.5-.8-2.4-.8-1 0-1.9.3-2.4.9-.6.6-.9 1.4-1.1 2.4h7zm0 0"/>
            </svg>
          </SocialLink>
        </Infos>
